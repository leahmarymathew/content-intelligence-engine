      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-slate-700">
          <div className="flex items-center space-x-2 min-w-0">
            ...
            <span className="text-sm font-semibold text-white leading-tight">Quill</span>
          </div>
          <button
            onClick={closeSidebar}
        ...
        <div className="px-3 py-4 border-t border-slate-700">
          <div className="flex items-center space-x-3 px-3 py-2 rounded-lg">
            <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center flex-shrink-0">
              <span className="text-white text-xs font-semibold">LM</span>
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-white truncate">Leah Mathew</p>
              <p className="text-xs text-slate-400 truncate">Content Strategist</p>
            </div>
          </div>
        </div>
      </aside>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="lg:hidden flex items-center px-4 py-3 bg-white border-b border-gray-200 flex-shrink-0">
          ...
          <div className="flex items-center ml-3 space-x-2">
            ...
            <span className="font-semibold text-gray-900 text-sm">Quill</span>
          </div>
        </header>
